    ...
    function ExternalSection({ t, readStatus, readWechat, toggleWechat, readRules, saveRules, readContacts }) {
      ...
      return jsx.jsxs("div", { children: [
        ...
        jsx.jsxs("div", { style: rulesCardStyle, children: [
          jsx.jsxs("button", { type: "button", onClick: function () { setRulesOpen(!rulesOpen); }, style: rulesHeaderStyle, children: [jsx.jsx("span", { children: "群聊与联系人规则" }), jsx.jsx("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontWeight: "400", fontSize: "13px" }, children: rulesOpen ? "收起" : "展开" })] }),
