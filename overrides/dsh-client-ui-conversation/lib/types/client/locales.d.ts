...
export declare const zh: {
    ...
    'context.aria': string;
    'context.used': string;
    'context.balance': string;
    'context.sessionUsed': string;
    ...
    'details.openExternal': string;
    'details.empty': string;
    'details.notInWindow': string;
    'details.input': string;
    'details.output': string;
    'details.running': string;
    'details.loading': string;
    'details.truncated': string;
    'details.wrap': string;
    'details.wrapLabel': string;
    'details.loadMore': string;
    'todo.title': string;
